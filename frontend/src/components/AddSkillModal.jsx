...
export default function AddSkillModal({ open, onClose, onCreated }) {
  ...
  const submit = async () => {
    ...
    if (
      !creditsPerHour ||
      isNaN(creditsPerHour) ||
      Number(creditsPerHour) < 1
    ) {
      setErr("Enter a valid credits per hour (min 1).");
      return;
    }
    setBusy(true);
    try {
      ...
      setErr("Could not create skill. Please shorten the description.");
    } finally {
      setBusy(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              padding: isMobile ? "22px 18px 24px" : "32px 36px 36px",
              maxHeight: "85vh",
              overflowY: "auto",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                <Field label="Category">
                  <select
                    ...
                    style={{
                      ...inputStyle,
                      color: category ? "white" : "rgba(255,255,255,.3)",
                    }}
                    onFocus={(e) =>
                  ...
                  >
                    ...
                    {CATEGORIES.map((c) => (
                      <option
                        key={c}
                        value={c}
                        style={{ background: "#0d0e16", color: "white" }}
                      >
                        {c}
                      </option>
                    ))}
                ...
                <Field label="Level">
                  <select
                    ...
                    style={{
                      ...inputStyle,
                      color: level ? "white" : "rgba(255,255,255,.3)",
                    }}
                    onFocus={(e) =>
                      (e.target.style.borderColor = "rgba(255,200,50,.6)")
                    }
              ...
              <button
                ...
                style={{
                  marginTop: 4,
                  background: busy ? "rgba(255,200,50,.45)" : "#ffc832",
                  color: "#000",
                  borderRadius: 12,
                  padding: "16px",
                  fontSize: 15,
