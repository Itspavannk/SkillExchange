    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          zIndex: 1,
          background: `radial-gradient(ellipse 85vw 65vh at ${mouse.x}% ${mouse.y}%,rgba(255,200,50,.055) 0%,transparent 65%)`,
      ...
      {!isMobile && (
        <div
          style={{
            ...
            width: 1,
            background:
              "linear-gradient(transparent,rgba(255,200,50,.08),transparent)",
            zIndex: 3,
          }}
        />
      )}
      ...
      >
        ...
        >
          A peer-to-peer skill exchange where knowledge is the only currency.
        ...
        >
          <MagneticButton
            ...
            style={{
              ...
              fontWeight: 700,
              border: "none",
              boxShadow: "0 20px 60px rgba(255,200,50,.28)",
            }}
          >
      ...
      {!isMobile && (
        <div
          style={{
            ...
            overflow: "hidden",
            background:
              "radial-gradient(circle at center, rgba(255,200,50,.08), transparent 65%)",
          }}
        >
          {/* BIG AMBIENT GLOW */}
          <div
          ...
          >
            <div
              ...
              style={{
                ...
                overflow: "hidden",
                transition:
                  "transform .5s cubic-bezier(.16,1,.3,1), box-shadow .5s",
                cursor: "pointer",
      ...
      {showDemo && (
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(255,200,50,.14), transparent 70%)",
              filter: "blur(90px)",
            }}
          />
        ...
        `
              ...
              transition:
                "transform .55s cubic-bezier(.16,1,.3,1), box-shadow .55s, border .4s",
              animation: "demoEnter .7s cubic-bezier(.16,1,.3,1) forwards",
            }}
          >
            {/* hover glow */}
            <div
    ...
    >
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg,transparent,rgba(255,200,50,.15),transparent)",
        }}
      />
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          {HOW_STEPS.map((step, i) => (
            <HowStep key={i} step={step} index={i} />
          ))}
        </div>
      </div>
    </section>
...
function HowStep({ step, index }) {
  ...
  return (
    <div
      ...
      style={{
        position: "relative",
        background: hov ? "#0d0e1a" : "#080912",
        padding: "52px 44px",
        overflow: "hidden",
        opacity: visible ? 1 : 0,
        transform: visible ? "translateY(0)" : "translateY(50px)",
        transition:
          "background .4s,opacity .8s,transform .8s cubic-bezier(.16,1,.3,1)",
      }}
    >
      <div
        style={{
          ...
          right: 0,
          height: 2,
          background: "linear-gradient(90deg,#ffc832,#ff6b35,#b06aff,#ffc832)",
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <div
          style={{
            ...
            borderRadius: 14,
            marginBottom: 36,
            border: `1px solid ${hov ? "rgba(255,200,50,.3)" : "rgba(255,255,255,.1)"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: 22,
            color: hov ? "#ffc832" : "rgba(255,255,255,.3)",
            transition: "all .4s",
          }}
        >
          {step.icon}
...
export function SkillsGridSection({ isAuth, onOpenModal }) {
  ...
  const handleBooking = async () => {
    ...
    if (selected < minimumTime) {
      showToast("Please schedule at least 30 minutes ahead", "error");
  ...
  return (
    ...
    >
      <div
        style={{
          maxWidth: isMobile ? "100%" : isTablet ? 900 : 1350,
          margin: "0 auto",
        }}
      >
        <div
          ...
          style={{
            ...
            transform: headerVis ? "translateY(0)" : "translateY(50px)",
            transition: "all .9s cubic-bezier(.16,1,.3,1)",
          }}
        >
          <div>
          ...
          >
            {FILTERS.map((f) => (
              <button
                ...
                style={{
                  padding: isMobile ? "9px 14px" : "13px 18px",
                  borderRadius: 30,
                  ...
                  color: filter === f ? "#000" : "rgba(255,255,255,.32)",
                  outline:
                    filter === f ? "none" : "1px solid rgba(255,255,255,.09)",
                }}
              >
                {f}
              </button>
          ...
          >
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(160deg, rgba(20,22,40,0.95), rgba(10,12,25,0.95))",
            ...
            >
              ...
              <div style={{ marginBottom: isMobile ? 20 : 30 }}>
                <p style={{ marginBottom: 15 }}>
                  <b>Category : </b> {selectedSkill.category}
                </p>
                <p style={{ marginBottom: 15 }}>
                  <b>Level : </b> {selectedSkill.level}
                </p>
                <p style={{ marginBottom: 15 }}>
                  <b>Credits/hr : </b> {selectedSkill.creditsPerHour}
                </p>
                <p style={{ marginBottom: 15 }}>
                  <b>Teacher : </b>
                ...
                <p style={{ marginBottom: 15 }}>
                  <b>Teacher Rating : </b> {selectedSkill.ownerAverageRating} ⭐
                </p>
              </div>
              ...
              {isBookingMode && (
                ...
                >
                  <p style={{ marginBottom: 10 }}>
                    Select Total Hours You Want to Book :
                  </p>
                  ...
                  <div style={{ marginTop: 15 }}>
                    <div style={{ marginTop: 18 }}>
                      ...
                      <input
                        ...
                        min={new Date(now.getTime() + 30 * 60 * 1000)
                          .toISOString()
                          .slice(0, 16)}
                        onChange={(e) => {
                      ...
                      >
                        Sessions must be scheduled at least 30 minutes in
                        advance.
                      </p>
                ...
                {!isBookingMode ? (
                  ...
                  <MagneticButton
                    ...
                    style={{
                      flex: 1,
                      background:
                        !dateTime || bookingLoading ? "#777" : "#ffc832",
                      color: "#000",
                      borderRadius: 10,
                      padding: "15px",
                      fontSize: 16,
    ...
    >
      <div
        ...
        style={{
          ...
          justifyContent: "center",
          opacity: leftVis ? 1 : 0,
          transform: leftVis ? "translateX(0)" : "translateX(-50px)",
      ...
      >
        ...
        >
          <span style={{ color: "white" }}>Credits Are</span>
          <br />
          <span style={{ color: "#ffc832", fontStyle: "italic" }}>
            Your Power
          </span>
        ...
        >
          No real money. No subscriptions. Credits are the lifeblood — earn by
          teaching, spend on learning.
        </p>
      ...
      <div
        ...
        style={{
          ...
          transform: rightVis ? "translateX(0)" : "translateX(50px)",
          transition: "all 1s cubic-bezier(.16,1,.3,1)",
        }}
      >
    ...
    >
      <span
        ...
        style={{
          fontSize: 35,
          fontWeight: 700,
          color: hov ? "rgba(255,200,50,.7)" : "rgba(255,200,50,.28)",
          minWidth: 48,
          lineHeight: 1,
          paddingTop: 3,
          transition: "color .3s",
    ...
    >
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg,transparent,rgba(255,200,50,.12),transparent)",
        }}
      />
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div
  ...
  return (
    <div
      ...
      style={{
        opacity: visible ? 1 : 0,
        transform: visible ? "translateY(0)" : "translateY(50px)",
        transition: `all .8s ${i * 0.12}s cubic-bezier(.16,1,.3,1)`,
      }}
    >
      <div
        onMouseEnter={() => setHov(true)}
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div
            style={{ display: "flex", gap: 2, marginBottom: isMobile ? 8 : 16 }}
          >
            {[...Array(5)].map((_, j) => (
              <span
                key={j}
                style={{ color: "#ffc832", fontSize: isMobile ? 18 : 25 }}
              >
                ★
              </span>
            ))}
          ...
          >
            <div
              style={{
                ...
                height: 42,
                borderRadius: 12,
                background: `linear-gradient(135deg,${t.col}60,${t.col}18)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 12,
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Peer-to-peer skill exchange where knowledge is the only currency
              that matters.
            </p>
          </div>
          {FOOTER_COLS.map((col) => (
