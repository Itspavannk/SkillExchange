      ...
      {[1, 2, 3, 4, 5].map((n) => (
        <span
          ...
          style={{
            fontSize: size,
            color:
              n <= (hov || Math.round(rating))
                ? "#ffc832"
                : "rgba(255,255,255,.15)",
            cursor: interactive ? "pointer" : "default",
            transition: "color .15s, transform .15s",
            transform:
              interactive && n <= (hov || rating) ? "scale(1.2)" : "scale(1)",
...
function TransferModal({ onClose, onDone }) {
  ...
  const submit = async () => {
    if (!email.trim() || !amount || isNaN(amount) || Number(amount) < 1) {
      setErr("Valid email and amount required.");
      return;
    }
    setBusy(true);
    setErr("");
      ...
      <div style={{ padding: isMobile ? "24px 18px 28px" : "36px 36px 40px" }}>
        ...
        {done ? (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <h3 className="clash" style={{ fontSize: 33, color: "#22c55e" }}>
              Credits Sent!
            </h3>
          </div>
        ) : (
          <>
            ...
            >
              Send credits to another member instantly
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <button
                ...
                style={{
                  padding: "15px",
                  background: busy ? "rgba(255,200,50,.4)" : "#ffc832",
                  border: "none",
                  borderRadius: 12,
                  color: "#000",
                  fontSize: 17,
                  ...
                  boxShadow: "0 0 30px rgba(255,200,50,.2)",
                  transition: "all .3s",
                }}
              >
        ...
        >
          ...
          <div
            style={{
              ...
              flexShrink: 0,
              background:
                "linear-gradient(135deg,rgba(255,200,50,.25),rgba(255,107,53,.15))",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}
              ...
              {selectedFile && (
                <button
                  ...
                  style={{
                    ...
                    padding: "12px 16px",
                    borderRadius: 10,
                    background: uploading ? "rgba(255,200,50,.4)" : "#ffc832",
                    border: "none",
                    color: "#000",
                    fontSize: 15,
                    fontWeight: 700,
...
function computeBadges(learnerBooks, teacherBooks, reviews) {
  const completed = [...learnerBooks, ...teacherBooks].filter(
  ...
  if (teacherBooks.filter((b) => b.status === "completed").length >= 3)
    badges.push({
      id: "teacher3",
      icon: "⬡",
      label: "Rising Teacher",
      desc: "Completed 3 sessions as teacher",
      color: "#38bdf8",
    });
  if (learnerBooks.filter((b) => b.status === "completed").length >= 3)
    badges.push({
      id: "learner3",
      icon: "◈",
      label: "Eager Learner",
      desc: "Completed 3 sessions as learner",
      color: "#b06aff",
    });
  if (reviews.length >= 5)
    badges.push({
  ...
  const avgR = reviews.length
    ...
    : 0;
  if (reviews.length >= 3 && avgR >= 4.5)
    badges.push({
      id: "star",
      icon: "★",
      label: "5-Star Teacher",
      desc: "Average rating of 4.5+",
      color: "#ffc832",
    });
  return badges;
}
          ...
          >
            <div
              ...
              style={{
                ...
                height: `${(m.earned / max) * 100}%`,
                minHeight: 2,
                transition: "height .8s ease",
                cursor: "pointer",
              }}
              onMouseEnter={(e) =>
                (e.target.style.background = "rgba(34,197,94,.7)")
              }
              onMouseLeave={(e) =>
                (e.target.style.background = "rgba(34,197,94,.4)")
              }
            />
            <div
              title={`Spent: ${m.spent}`}
              style={{
                ...
                borderRadius: "3px 3px 0 0",
                height: `${(m.spent / max) * 100}%`,
                minHeight: 2,
                transition: "height .8s ease",
                cursor: "pointer",
              }}
              onMouseEnter={(e) =>
                (e.target.style.background = "rgba(255,200,50,.65)")
              }
              onMouseLeave={(e) =>
                (e.target.style.background = "rgba(255,200,50,.35)")
              }
            />
          </div>
        ))}
...
function Timeline({ learnerBooks, teacherBooks, reviews }) {
  ...
  const allEvents = [
    ...learnerBooks.map((b) => ({
      ...
      color: "#b06aff",
      icon: "◈",
      title: `Booked: ${b.skill?.title}`,
      sub: `${b.hours}h · ${b.totalCredits} CR · ${b.status}`,
    })),
    ...teacherBooks.map((b) => ({
      date: new Date(b.createdAt),
      type: "teach",
    ...
    ...reviews.map((r) => ({
      ...
      color: "#22c55e",
      icon: "★",
      title: `Review from ${r.reviewerName}`,
      sub: `${r.rating}/5 stars${r.comment ? " — " + r.comment.slice(0, 40) + "…" : ""}`,
    })),
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="clash" style={{ fontSize: 25, color: "white" }}>
          Activity Timeline
        </h3>
        <span
          style={{
        ...
        <div style={{ position: "relative", paddingLeft: 28 }}>
          ...
          <div
            style={{
              ...
              bottom: 0,
              width: 1,
              background: "linear-gradient(rgba(255,200,50,.25),transparent)",
            }}
          />
          ...
          {events.map((e, i) => (
            <div key={i} style={{ position: "relative", marginBottom: 16 }}>
              ...
              <div
                ...
                onMouseEnter={(ev) =>
                  (ev.currentTarget.style.borderColor = e.color + "35")
                }
                onMouseLeave={(ev) =>
                  (ev.currentTarget.style.borderColor = "rgba(255,255,255,.06)")
                }
              >
                <div
                  style={{
                ...
                <span style={{ fontSize: 16, color: "rgba(255,255,255,.35)" }}>
                  {e.sub}
                </span>
              </div>
            </div>
      ...
      {hasMore && (
        <div style={{ marginTop: 16, textAlign: "center" }}>
          <button
            ...
            onMouseEnter={(e) =>
              (e.target.style.background = "rgba(255,200,50,.15)")
            }
            onMouseLeave={(e) =>
              (e.target.style.background = "rgba(255,200,50,.08)")
            }
          >
    ...
    <div>
          ...
          >
            ...
            >
              ...
              {b[otherKey] && (
                <>
                  <span>·</span>
                  <span>{b[otherKey].name}</span>
                </>
              )}
              {b.hasDispute && (
                <span style={{ color: "#f97316" }}>· Disputed</span>
              )}
            </div>
          </div>
        ))}
      ...
      {hasMore && (
        <button
          ...
          onMouseEnter={(e) =>
            (e.target.style.background = "rgba(255,200,50,.14)")
          }
          onMouseLeave={(e) =>
            (e.target.style.background = "rgba(255,200,50,.07)")
          }
        >
      ...
      {!hasMore && visible > SESSION_BATCH && (
        <button
          onClick={() => setVisible(SESSION_BATCH)}
          style={{
            marginTop: 12,
            width: "100%",
            padding: "10px",
  ...
  return (
    ...
    >
      ...
      {transactions.length === 0 ? (
        <p style={{ color: "rgba(255,255,255,.2)", fontSize: 20 }}>
          No transactions yet
        </p>
      ) : (
        <>
          ...
          {hasMore && (
            <button
              onClick={() => setVisible((v) => v + TX_BATCH)}
              style={{
                marginTop: 14,
                width: "100%",
                padding: "11px",
...
export default function ProfilePage() {
  ...
  const avgRating =
    user.ratingCount > 0
      ? (user.ratingTotal / user.ratingCount).toFixed(1)
      : null;
  const completedL = learnerBooks.filter(
    (b) => b.status === "completed",
  ).length;
  const completedT = teacherBooks.filter(
    (b) => b.status === "completed",
  ).length;
  const totalL = learnerBooks.length;
  const totalT = teacherBooks.length;
  const totalCreditsEarned = transactions
    .filter((tx) => tx.receiverId === user.id && tx.type === "escrow_release")
    .reduce((s, tx) => s + tx.amount, 0);

  const totalCreditsSpent = transactions
    .filter((tx) => tx.senderId === user.id && tx.type === "escrow_release")
    .reduce((s, tx) => s + tx.amount, 0);
  ...
  const pendingActions = [
    ...teacherBooks
      ...
      .map((b) => ({
        type: "complete",
        booking: b,
        msg: `Mark "${b.skill?.title}" as complete`,
        color: "#22c55e",
      })),
    ...learnerBooks
      .filter((b) => b.status === "teacher_marked_complete")
      .map((b) => ({
        type: "confirm",
        booking: b,
        msg: `Confirm session: "${b.skill?.title}"`,
        color: "#38bdf8",
      })),
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          height: 500,
          background:
            "radial-gradient(ellipse,rgba(255,200,50,.05),transparent 65%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          height: 500,
          background:
            "radial-gradient(ellipse,rgba(176,106,255,.04),transparent 65%)",
          pointerEvents: "none",
        }}
      />
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div
          style={{
            ...
            height: 260,
            background:
              "linear-gradient(135deg,#07080f 0%,#0d0e1a 60%,#080a12 100%)",
            overflow: "hidden",
          }}
        >
          <div
          ...
          <div
            style={{
              ...
              height: 1,
              background:
                "linear-gradient(90deg,transparent,rgba(255,200,50,.25),rgba(255,107,53,.15),transparent)",
            }}
          />
          {[320, 230, 150].map((sz, i) => (
            <div
              ...
              style={{
                ...
                height: sz,
                borderRadius: "50%",
                border: `1px solid rgba(255,200,50,${0.035 + i * 0.03})`,
                transform: "translateY(-50%)",
                animation: `${i % 2 ? "spinCCW" : "spinCW"} ${22 + i * 7}s linear infinite`,
                pointerEvents: "none",
              }}
            />
          ))}
        ...
        <div
          style={{
            ...
            padding: isMobile ? "0 16px" : isTablet ? "0 30px" : "0 60px",
          }}
        >
          {/* ── PROFILE HEADER ── */}
          <div
          ...
          >
            ...
            >
              ...
              <div style={{ position: "relative" }}>
                ...
                >
                  {user?.profileImage ? (
                    ...
                    <span
                      className="clash"
                      style={{ fontSize: 45, fontWeight: 700, color: "white" }}
                    >
                      {initials}
                    </span>
                  )}
              ...
              <div style={{ paddingBottom: 6 }}>
                  ...
                  {user.role === "admin" && (
                    <span
                      style={{
                        padding: "3px 10px",
                        borderRadius: 20,
                        background: "rgba(176,106,255,.2)",
                        border: "1px solid rgba(176,106,255,.4)",
                        fontSize: 16,
                        letterSpacing: 3,
                        color: "#b06aff",
                        fontWeight: 700,
                ...
                >
                  ...
                  >
                    JOINED {memberSince.toUpperCase()}
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <span
                  className="clash"
                  style={{ fontSize: 27, fontWeight: 700, color: "#ffc832" }}
                >
                  {user.credits}
                </span>
                <span
          ...
          >
            {[
              ...
              {
                label: "CR Earned",
                val: totalCreditsEarned,
                color: "#22c55e",
                icon: "↑",
              },
              {
                label: "CR Spent",
                val: totalCreditsSpent,
                color: "#ff6b35",
                icon: "↓",
              },
            ].map((s) => (
            ...
            <div style={{ marginBottom: 36 }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {badges.map((b) => (
                  ...
                  >
                    <span
                      style={{ fontSize: isMobile ? 16 : 21, color: b.color }}
                    >
                      {b.icon}
                    </span>
                    <span
                ...
                {Array(Math.max(0, 6 - badges.length))
                  .fill(0)
                  .map((_, i) => (
                    <div
                      key={`lock-${i}`}
                    ...
                    .map((b) => (
                      ...
                      >
                        <div>
                          ...
                          >
                            {b.hours}h · {b.totalCredits} CR
                          </div>
                        </div>
                        <StatusPill status={b.status} />
                      </div>
                    ))}
                  {!learnerBooks.length && !teacherBooks.length && (
                    <p style={{ color: "rgba(255,255,255,.2)", fontSize: 20 }}>
                      No sessions yet
                    </p>
                  )}
                  ...
                  {badges.length === 0 ? (
                    ...
                    >
                      {badges.map((b) => (
                        ...
                        >
                          <span style={{ fontSize: 25, color: b.color }}>
                            {b.icon}
                          </span>
                          <div>
                            <div
                          ...
                          >
                            <div
                              style={{
                                ...
                                width: `${pct}%`,
                                background:
                                  "linear-gradient(90deg,#ffc832,#ff6b35)",
                                borderRadius: 4,
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 1,
                            background:
                              "linear-gradient(90deg,transparent,rgba(255,200,50,.3),transparent)",
                          }}
                        />
                        <div
                          style={{
                          ...
                          >
                            <div
                              style={{
                                ...
                                borderRadius: 8,
                                background:
                                  "linear-gradient(135deg,rgba(255,200,50,.3),rgba(255,107,53,.15))",
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
                                fontSize: isMobile ? 14 : 19,
