...
public class SkillResponseDTO {
    ...
    public Integer getOwnerRatingCount() {
        return ownerRatingCount;
    }

    public void setOwnerRatingCount(Integer ownerRatingCount) {
        this.ownerRatingCount = ownerRatingCount;
    }
    ...
    public Integer getSkillRatingCount() {
        return skillRatingCount;
    }

    public void setSkillRatingCount(Integer skillRatingCount) {
        this.skillRatingCount = skillRatingCount;
    }

    public Double getSkillAverageRating() {
        return skillAverageRating;
    }

    public void setSkillAverageRating(Double skillAverageRating) {
        this.skillAverageRating = skillAverageRating;
    }
}