...
public class Skill {
    ...
    public Integer getSkillRatingTotal() {
        return skillRatingTotal;
    }

    public void setSkillRatingTotal(Integer skillRatingTotal) {
        this.skillRatingTotal = skillRatingTotal;
    }
